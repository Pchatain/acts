...
BIGK = 100000
PATH = "../../../build/bin/"
plotDirectory = PATH + "zzzCleanTest" #"zzTestingITK_k100,000_gen200" #"yES_7params_scored4_muon_gen" + str(NGEN) + "_pop50_srange0.01-0.3_eval1" # "zES_7params_scored1_muon_gen200_pop50_srange0.01-0.3_eval2" # Where to save the plots
plotDirectory += "/"
ttbarSampleInput = ['--input-dir', PATH + 'sim_generic_ATLASB_ttbar_e4_pu200_eta2.5/']
ttbarSampleBool = False
ITKSampleInput = ['--input-dir', PATH + 'sim_generic_e1_p10000_testingPurposes/']
ITKSampleBool = False
config_ml = ['--output-dir', PATH + 'tmpPerf/', '--input-dir', PATH + 'sim_generic_e1_p10000_pT0.1-100_eta-2.5-2.5/', '--sf-fltPrtEtaMin', '-2.5', '--sf-fltPrtEtaMax', '2.5', '--sf-fltPrtPtMin', '0.5', '--sf-fltPrt3Hits', 'true', '--sf-fltPrtOuterHits', 'true', '--sf-rMax', '200', '--sf-collisionRegionMin', '-300', '--sf-collisionRegionMax', '300', '--sf-minPt', '500', '--sf-zMin', '-2000', '--sf-zMax', '2000', '--sf-bFieldInZ', '0.00199724', '--sf-cotThetaMax', '7.40627', '--output-ML', 'true', '-l', '4']
...
def paramsToInput(params, names):
    ret = [PATH + 'ActsExampleTestSeedAlgorithm']
    if (ttbarSampleBool):
...
def executeAlg(args):
    p2 = subprocess.Popen(
        args, bufsize=4096, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
